...
-(void)loadDataFromDatabase {
    ...
    NSManagedObject *clients = [NSEntityDescription insertNewObjectForEntityForName:@"Users" inManagedObjectContext:context];
...
{
    return [[UITabBarItem alloc] initWithTitle:@"blag" image:[UIImage imageNamed:@"Blah.png"] tag:0];
}
